    ...
    return (
        <>
            <style dangerouslySetInnerHTML={{
                ...
                .divyayatra-header, .divyayatra-header * { font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen, Ubuntu, Cantarell, "Open Sans", "Helvetica Neue", sans-serif !important; }
            ` }} />
            ...
            <header
                ...
                className={`divyayatra-header fixed left-0 w-full z-50 bg-white border-b border-gray-100 transition-all duration-300 ${isScrolled ? "py-2 shadow-md" : "py-3 shadow-sm"}`}
            >
